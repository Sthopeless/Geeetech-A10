...
#define STRING_CONFIG_H_AUTHOR "(Sthope, Geeetech A10)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "  Marlin v2.0 by" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Hopeless Automations"         // will be shown during bootup in line 2
